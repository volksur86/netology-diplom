...
Создаем дашборды для мониторинга наших веб серверов по процессорам, памяти, дискам, сети и т.д., из перечня можно настроить уведомления по многим параметрам, какие необходимы.
